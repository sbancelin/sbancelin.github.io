...
<div class="row align-items-center justify-content-center">
  ...
  <div class="col-md-5 mt-3 mt-md-0">
    <p class="caption" style="text-align: left;">STED principle: a doughnut-shaped depletion beam confines fluorescence to a sub-diffraction spot (a); the STED microscope (c); and the resulting PSFs and beads for 2P, 2D-, z- and 3D-STED (d–e).</p>
  </div>
</div>
...
<div class="row align-items-center justify-content-center">
  ...
  <div class="col-md-5 mt-3 mt-md-0">
    <p class="caption" style="text-align: left;">In vivo STED imaging of dendritic spines along a dendrite in the living mouse brain (top, 14×7 µm²), and a 3D comparison of a spine imaged with two-photon vs STED microscopy (bottom).</p>
  </div>
</div>
...
<div class="row align-items-center justify-content-center">
  ...
  <div class="col-md-5 mt-3 mt-md-0">
    <p class="caption" style="text-align: left;">SUSHI (super-resolution shadow imaging): the extracellular space is labelled so that cells and processes appear as dark shadows, revealing the full tissue anatomy in vivo.</p>
  </div>
</div>